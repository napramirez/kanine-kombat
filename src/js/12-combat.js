...
function createTeamHUD() {
  ...
  sides.forEach(s => {
    ...
    n1.style.cssText = `position:absolute;top:12px;${xStyle}font-size:11px;font-family:'Press Start 2P',monospace;text-shadow:2px 2px 2px #000,-1px -1px 1px #000,1px -1px 1px #000,-1px 1px 1px #000;z-index:1;pointer-events:none;height:30px;line-height:30px;`;
    ...
    n2.style.cssText = `position:absolute;top:82px;${xStyle}font-size:11px;font-family:'Press Start 2P',monospace;text-shadow:2px 2px 2px #000,-1px -1px 1px #000,1px -1px 1px #000,-1px 1px 1px #000;z-index:1;pointer-events:none;height:30px;line-height:30px;`;
